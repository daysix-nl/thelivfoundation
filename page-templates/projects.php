...
<main>
    ...
    <section class="relative w-full h-[50vh] md:h-[90vh] overflow-hidden items-center">
        <img src="/wp-content/themes/thelivfoundation/img/local/background-projects.jpg" alt="" class="absolute left-0 top-0 -z-10 h-full w-full object-cover">
        <div class="container grid mt-[20vh] md:mt-[40vh] text-center items-center">
            <div class="title-effect-seven">
                <h2 class="text-60 leading-50 md:text-100 md:leading-90 font-onemedium text-white pb-[12px]">Our projects</h2>
            </div>
        </div>
    </section>

    <section class="background-linear-thirteen h-[100%] pb-[150px]">
        <div class="container pt-8 md:pt-12 grid grid-cols-1 md:grid-cols-10">
            <div class="col-span-10 md:col-span-6 mb-3">
                <h2 class="text-22 leading-36 text-livblue font-onebold">Project selection</h2>
            </div>
        </div>
        <div class="container grid grid-cols-8 gap-3 md:gap-x-8">
            <div class="col-span-8 md:col-span-3">
                <P class="text-18 leading-28 text-white font-oneregular">Our board meets quarterly to consider new projects and assess the progress of existing ones. To be eligible as a potential beneficiary, projects must to meet all of the following conditions:</P>
            </div>
            <div class="col-span-8 md:col-span-5">
                <ul class="dashed">
                    <li class="text-18 leading-28 text-white font-oneregular">Be non-profit in nature</li>
                    <li class="text-18 leading-28 text-white font-oneregular">Aim to benefit highly vulnerable population group(s) in low-income countries</li>
                    <li class="text-18 leading-28 text-white font-oneregular">Align with the foundation’s mission to provide equal access to quality education</li>
                    <li class="text-18 leading-28 text-white font-oneregular">Aim to work toward at least one of our <a href="/about-us/#target-sdgs" class="underline">9 target SDGs</a></li>
                    <li class="text-18 leading-28 text-white font-oneregular">Demonstrable prioritisation of the foundation’s <a href="/about-us/#our-values" class="underline">core values </a></li>
                    <li class="text-18 leading-28 text-white font-oneregular">Be able to generate a detailed budget Have a clear, measurable improvement plan </li>
                </ul>
            </div>
    ...
    <section class="relative">
        <div class="mt-[-80px] md:mt-[-150px] absolute left-0 right-0">
            <div class="title-effect-nine container">
                <P class="md:text-center text-60 leading-50 md:text-100 md:leading-100 text-livred font-onemedium pb-[12px]">Our current<br>projects</P>
            </div>
        </div>
    </section>

    <section class="bg-livblue md:h-[50px]"></section>

    <!--FLEXIBLE BLOCK START  -->
    <section class="bg-livblue">
        <div class="container pt-8 md:pt-12 grid grid-cols-1">
            <div class="col-span-1 mb-6">
                <p class="text-26 leading-40 text-livred font-onemono">The Cholankande Youth <br>Training Centre</p>
            </div>
        </div>
    </section>
    <section class="bg-livblue">
        <div class="container grid grid-cols-1">
            <div class="col-span-1 mb-1 md:mb-3">
                <h2 class="text-22 leading-36 text-white font-onebold">History</h2>
            </div>
        </div>
        <div class="container grid grid-cols-10 gap-3 pb-6">
            <div class="col-span-10 md:col-span-7 md:mr-3">
                <p class="text-18 leading-28 text-white font-oneregular">The Cholankande Youth Training Centre was founded in 1988 by Italian Jesuit Missionary, Rev. Fr. Carmine Jannaccone. Originally established as an orphanage for area boys, the CYTC’s goal has always been to help the community of impoverished plantation-workers in the remote regions of central Sri Lanka. Over the last 30+ years the CYTC has grown into a full-fledged vocational training centre. Today, the CYTC is owned and operated by the Sri Lanka Jesuits. Their continuing mission is to fight poverty and empower youth by delivering government-accredited training programmes irrespective of gender, religion or ethnicity.</p>
            </div>
            <div class="col-span-10 md:col-span-3 w-[200px] md:w-[100%]">
                <div class="relative">
                    <img class="" src="/wp-content/themes/thelivfoundation/img/local/foto-001.jpg" alt="">
    ...
    <section class="bg-livblue">
        <div class="container grid grid-cols-10 gap-3 pb-6">
            <div class="col-span-10 md:col-span-3 w-[200px] md:w-[100%] order-2 md:order-1">
                <div class="relative">
                    <img class="" src="/wp-content/themes/thelivfoundation/img/local/foto-003.jpg" alt="">
                    <div class="absolute left-0 top-0 right-0 h-[100%] background-linear-fourteen"></div>
                </div>
            </div>
            <div class="col-span-10 md:col-span-7 md:ml-3 order-1 md:order-2">
                <h2 class="text-22 leading-36 text-white font-onebold mb-1 md:mb-3 pt-3">Location</h2>
                <p class="text-18 leading-28 text-white font-oneregular">The CYTC is located in the mountainous central province of Sri Lanka, 38 km southwest of Kandy on 12 acres of land in Nawalapitiya. Positioned within the central tea-growing region CYTC works to bring opportunity to the underserved families of the rural plantation-workers.</p>
            </div>
           
        </div>
    </section>
    <section class="bg-livblue">
        <div class="container grid grid-cols-10 gap-3 pb-4 md:pb-12">
            <div class="col-span-10 md:col-span-7 md:mr-3">
                <h2 class="text-22 leading-36 text-white font-onebold mb-1 md:mb-3">Offering</h2>
                <p class="text-18 leading-28 text-white font-oneregular">The centre works to fight poverty, bring about ethnic and religious harmony, and instill a deep appreciation and respect for nature by delivering vocational training programmes in an inclusive and sustainable environment. Currently, the CYTC offers government-registered vocational training programmes in electrical engineering, motor mechanics and computer science, as well as supporting programmes in English and mathematics.</p>
            </div>
            <div class="col-span-10 md:col-span-3 w-[200px] md:w-[100%]">
                <div class="relative">
                    <img class="" src="/wp-content/themes/thelivfoundation/img/local/foto-004.jpg" alt="">
